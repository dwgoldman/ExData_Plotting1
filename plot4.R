##program to create the a panel of 4 plots for Plot 4 for Assignment 1
...
##set frame layout to 2 rows, 2 cols
par(mfcol=c(2,2))
...
with(PowerData,plot(Date.Time,Voltage,xlab="datetime",type="l"))

##create fourth histogram
with(PowerData,plot(Date.Time,Global_reactive_power,xlab="datetime",type="l"))
